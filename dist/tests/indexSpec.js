...
describe("Test responses from endpoints", function () {
    ...
    describe("endpoint: /api/images", function () {
        ...
        it("gets /api/images?filename=fjord", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it("gets /api/images?filename=fjord&width=700&height=700", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get("/api/images?filename=fjord&width=700&height=700")];
                    case 1:
                        response = _a.sent();
                        expect(response.status).toBe(200);
                        return [2 /*return*/];
